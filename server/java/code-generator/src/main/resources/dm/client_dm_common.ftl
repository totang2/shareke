...
import club.xyou.fallback.${table.className}ClientFallBack;
import java.util.List;
import java.util.Map;

import club.xyou.config.XyouConfiguration;
...
@FeignClient(name = "xyou-common-provider", configuration = XyouConfiguration.class, fallback = ${table.className}ClientFallBack.class)
