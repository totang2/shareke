package club.${package}.client;
import club.${package}.pojo.${table.className};

import club.${package}.fallback.${table.className}ClientFallBack;
import java.util.List;
import java.util.Map;

import club.${package}.config.XyouConfiguration;
...
@FeignClient(name = "xyou-course-provider", configuration = XyouConfiguration.class, fallback = ${table.className}ClientFallBack.class)
