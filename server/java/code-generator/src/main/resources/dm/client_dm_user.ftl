...
import club.xyou.config.DmConfiguration;
...
@FeignClient(name = "xyou-user-provider", configuration = XyouConfiguration.class, fallback = ${table.className}ClientFallBack.class)
