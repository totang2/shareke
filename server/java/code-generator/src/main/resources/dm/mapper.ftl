...
<mapper namespace="club.${package}.mapper.${table.className}Mapper">

    <select id="get${table.className}ById" resultType="club.${package}.pojo.${table.className}">
        select
    ...
    <select id="get${table.className}ListByMap" resultType="club.${package}.pojo.${table.className}" parameterType="java.util.Map">
        select
        <#list table.cloumns as cloumn>
            <#if cloumn_has_next>
                ${cloumn.cloumnName} as ${cloumn.fieldName},
    ...
    <insert id="insert${table.className}" parameterType="club.${package}.pojo.${table.className}">
    ...
    <update id="update${table.className}" parameterType="club.${package}.pojo.${table.className}">
